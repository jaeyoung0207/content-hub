...
import com.cjy.contenthub.detail.function.DetailWishlistSetter;
...
public interface DetailInformationNoCacheService {
	...
	<T> void setWishlistFromResponse(
			DetailWishlistSetter<T> wishlistSetter, T detailResponse, Function<T, String> idExtractor, String originalMediaType, Long userId);
