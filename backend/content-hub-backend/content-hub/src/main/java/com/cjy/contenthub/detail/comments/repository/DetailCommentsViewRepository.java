package com.cjy.contenthub.detail.comments.repository;
 ...
 */
@Repository
public interface DetailCommentsViewRepository extends JpaRepository<DetailCommentsViewEntity, Long> {
	 ...
	 * @return 상세 코멘트 페이지
	 */
	Page<DetailCommentsViewEntity> findByContentMediaTypeAndApiId(String contentMediaType, String apiId, Pageable pageable);
	 ...
	 * @return 상세 코멘트 뷰 엔티티
	 */
	DetailCommentsViewEntity findByContentMediaTypeAndApiIdAndProviderId(String contentMediaType, String apiId, String providerId);
