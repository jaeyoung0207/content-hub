...
public interface DetailRecommendationMapper {
	...
	DetailComicsRecommendationsResultDto deepCopyForRecommendationsComicsResults(DetailComicsRecommendationsResultDto source);
	...
	List<DetailComicsRecommendationsResultDto> deepCopyForRecommendationsComicsResultsList(List<DetailComicsRecommendationsResultDto> sourceList);
