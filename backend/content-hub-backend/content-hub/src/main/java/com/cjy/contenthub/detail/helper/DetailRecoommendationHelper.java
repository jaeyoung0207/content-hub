...
public class DetailRecoommendationHelper {
	 ...
	 */
	public void getComicsRelations(AniListMediaDto media, List<DetailComicsRecommendationsResultDto> results) {
	 ...
	 * @param results 결과 리스트
	 */
	public void getComicsRecommendations(AniListMediaDto media, List<DetailComicsRecommendationsResultDto> results) {
