...
import com.cjy.contenthub.core.constants.DomainEnum.AniListGenreEnum;
 ...
 */
@Service
public class GenreSharedService {
	 ...
	 * @return 드라마 장르 여부
	 */
	public boolean isDramaGenre(Map<String, Integer> tvGenreMap, List<Integer> genreIds) {
	 ...
	 * @return
	 */
	public boolean isVarietyGenre(Map<String, Integer> tvGenreMap, List<Integer> genreIds) {
	 ...
	 * @return 타겟 장르 여부
	 */
	public boolean isTargetGenre(Map<String, Integer> genreMap, List<Integer> genreIds, String targetGenreName) {
	 ...
	 */
	public String getContentMediaTypeByGenre(Map<String, Integer> tvGenreMap, List<Integer> genreIds) {
