...
export const Character = () => {
    ...
    // characterId가 없는 경우, 이전 페이지로 이동
    if (!characterId) {
        console.error("characterId가 없습니다.");
        toast.error("캐릭터 ID가 없습니다.", { toastId: "noCharacterId" });
        navigate(-1);
        return;
    }
    ...
    // 생년월일 변환
    const birthday = data?.dateOfBirth ? convertBirthDate(data.dateOfBirth.year, data.dateOfBirth.month, data.dateOfBirth.day) : "";
                ...
                <>
                    <div className="flex justify-center m-5">
                        ...
                        <div className="flex justify-center items-center mb-4 w-[30%]">
                            <img
                                src={data.image?.large ? data.image.large : COMMON_IMAGES.NO_IMAGE}
                                onError={(e) => {
                            ...
                            <ul className="mt-5">
                                ...
                                {/* 참고URL */}
                                {
                                    ...
                                    <li className={characterInfoStyle}>
                                        ...
                                        <a href={data.siteUrl} target="_blank" className="text-blue-500 hover:underline">
                                            {data.siteUrl}
                                        </a>
                                    </li>
                                }
