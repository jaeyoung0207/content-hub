import { MEDIA_TYPE, IS_MOBILE, TMDB_API_IMAGE_DOMAIN, WIDTH_300, COMMON_IMAGES } from "@/components/common/constants/constants";
                        ...
                        <>
                            ...
                            <div className="flex justify-center items-center mb-4 w-[30%]">
                                <img
                                    ...
                                    alt={isTvType ? data.name : isMovieType ? data.title : isComicsType ? data.title : ""}
                                />
                            </div>
                            {/* 제목 */}
