...
import { isDetailComicsType, isDetailMovieType, isDetailTvType } from "@/components/common/utils/commonUtil";
                                ...
                                <div className="relative flex flex-wrap items-start mt-5">
                                    {
                                        detailResult.credits.cast.map((items, index) => {
                                            return (
                                                <div className="ml-1 mr-1 w-[190px]" key={index}>
                                                    <ul className="block">
                                                        ...
                                                        <li className="ml-1 mr-1 mb-4 text-xl">
                                                            {
                                                                items.name! + (items.character && "(" + items.character + "역)")
                                                            }
                                                        </li>
                                                    </ul>
                                                </div>
                        ...
                        <div className="relative flex flex-wrap items-start mt-5">
                            {
                                detailResult.characters.nodes.map((items, index) => {
                                    return (
                                        <div className="ml-1 mr-1 w-[110px]" key={index}>
                                            <ul className="block">
