...
export const DetailComments = ({
  ...
  const commentButtonStyle =
    'w-20 h-10 rounded-md bg-blue-600 text-base sm:text-lg disabled:bg-gray-400 text-white cursor-pointer disabled:cursor-not-allowed';
  // 코멘트 최대 글자 수
  ...
  return (
    <>
      ...
      <div className="md:px-2 lg:px-8">
        <div className="mb-1 flex justify-items-start border-b border-gray-300 px-1 text-lg font-bold md:px-2 md:text-2xl lg:mx-4">
      ...
      <div className="md:px-2 lg:px-8">
        {data?.pages.flat().map((items, index) => {
          ...
          return (
            <article
              key={items.commentId}
              className="py-4 md:px-2 lg:mx-2 lg:px-4"
            ...
            >
              <div className="flex items-center">
                ...
                />
                {/* 별점 표시 */}
                <div className="ml-2 text-sm">{items.starRating}</div>
              </div>
              {/* 헤더 */}
              <div className="mt-2 flex justify-between">
                <div className="mb-1 flex items-center">
                  {/* 작성자 */}
                  <div className="mr-3 text-base font-bold sm:text-lg">
                    {items.nickname}
                  </div>
                  {/* 작성 일자 */}
